...
- [ ] `pubspec.yaml` has:
  ...
  - `homepage: https://github.com/elbaf-game-hub/sudoku`
  - `repository: https://github.com/elbaf-game-hub/sudoku`
  - `issue_tracker: https://github.com/elbaf-game-hub/sudoku/issues`
